        ...
        $rootNode
            ->children()
                ->arrayNode('proxy_client')
                    ->children()
                        ->enumNode('default')
                            ->values(['varnish', 'nginx', 'fastly', 'symfony', 'noop'])
                        ...
                        ->arrayNode('fastly')
                            ->children()
                                ->scalarNode('authentication_token')
                                    ->info('Fastly auth token.')
                                ->end()
                                ->scalarNode('service_identifier')
                                    ->info('Fastly service identifier.')
                                ->end()
                                ->booleanNode('soft_purge')
                                    ->defaultTrue()
                                    ->info('Disable soft purge mode (enabled by default)')
                                ->end()
                                ->arrayNode('http')
                                    ->children()
                                        ->scalarNode('base_url')
