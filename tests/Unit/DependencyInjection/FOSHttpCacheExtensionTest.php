...
class FOSHttpCacheExtensionTest extends TestCase
{
     ...
     * @param string|int|null $serversFromJsonEnvValue string that should contain an env var (use `VARNISH_SERVERS` for this test), `null` if not set
    ...
    public function testVarnishServersConfig(?array $serversValue, string|int|null $serversFromJsonEnvValue, mixed $envValue, ?array $expectedServersValue, ?string $expectExceptionClass, ?string $expectExceptionMessage): void
    {
