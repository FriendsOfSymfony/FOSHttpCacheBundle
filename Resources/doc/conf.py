...
copyright = '2014-2015, David de Boer, David Buchmann'
...
htmlhelp_basename = 'FOSHttpCacheBundledoc'
...
latex_documents = [
  ('index', 'FOSHttpCacheBundle.tex', 'FOSHttpCacheBundle Documentation',
   'David de Boer, David Buchmann', 'manual'),
]
